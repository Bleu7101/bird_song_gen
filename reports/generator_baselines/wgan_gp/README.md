...
The selected CRNN matched the requested class on only 40.63% of 192 WGAN
samples and heavily favored American Robin. This weak three-species
conditioning is one reason not to treat classifier readability as realism.
...
diversity, and selected-CRNN conditioning; the current maximum-detail rule
