...
the low-resource augmentation experiment, and the VAE--Diffusion timing
comparison. Vincent Wang developed and evaluated the conditional Diffusion
...
\drafttodo{Insert verified generated-to-test and real-to-real MSE after the
canonical VAE pool is regenerated.}
...
objective. The historical notebook implements sampling temperature 0.35, but
the portable pool generator currently records 0.35 while omitting this factor
from reparameterization. The final generated-to-test MSE and timing comparison
must therefore use a corrected, hash-recorded pool.
